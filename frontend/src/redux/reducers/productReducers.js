...
export const updateProductReducer = (state = updateProductInitialState, action) => {
    switch (action.type) {
...
const deleteReviewInitialState = {
    isLoading: false,
    isError: false,
    error: "",
    isSuccess: false,
...
export const deleteReviewReducer = (state = deleteReviewInitialState, action) => {
    switch (action.type) {
